...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col relative overflow-hidden">
      {/* Background blobs */}
      <div className="bg-blob w-[500px] h-[500px]" style={{ top: "-8rem", left: "-8rem", background: "#FF2D78" }} />
      <div className="bg-blob w-96 h-96" style={{ top: "30%", right: "-6rem", background: "#7C3AED" }} />
      <div className="bg-blob w-80 h-80" style={{ bottom: "8rem", left: "30%", background: "#06B6D4" }} />

      {/* Hero */}
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 pt-16 pb-12">
        {/* Mirror emoji */}
        <div className="text-7xl mb-6 select-none" style={{ animation: "float 3s ease-in-out infinite" }}>
          🪞
        </div>
        ...
        <div className="text-center mb-10">
          <h1
            ...
            style={{
              background: "linear-gradient(135deg, #FF2D78 0%, #7C3AED 50%, #06B6D4 100%)",
          ...
          <p className="text-base font-semibold mt-2 max-w-xs mx-auto leading-relaxed" style={{ color: "#6B5F80" }}>
            用AI蒸馏你的交易历史 ✨
          </p>
        ...
        <div className="w-full max-w-lg">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2">
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    loading || !address.trim() ? "none" : "0 4px 16px rgba(124,58,237,0.4)",
                }}
              >
                {loading ? (
          ...
          {error && (
            <p className="text-xs px-2 mt-2 font-semibold" style={{ color: "#FF2D55" }}>
              {error}
            </p>
          )}

          <p className="text-center text-xs mt-4 font-medium" style={{ color: "#C4B5FD" }}>
      ...
      {/* Footer */}
      <footer className="relative z-10 text-center py-6 text-xs font-medium" style={{ color: "#A89EC4" }}>
        <div className="mb-1">
        ...
        <div>
          Robinhood 用户？自己跑本地版 →{" "}
          <a
            href="https://github.com/yourusername/lai-shi-lu#portable-skill"
            style={{ color: "#7C3AED" }}
            target="_blank"
            rel="noopener noreferrer"
          >
