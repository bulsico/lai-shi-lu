...
# 或者分析 Robinhood CSV
/trade-roast --rh ~/Downloads/你的robinhood导出.csv
```

**如何从 Robinhood 导出 CSV：**
- 股票/期权：Account → Statements & History → Generate Report
- 加密货币：Account → Crypto → Transaction History → Export
